...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/PPI-App-ppi_version-BDFOY> or 
L<MetaCPAN|http://www.metacpan.org/module/PPI::App::ppi_version::BDFOY>:

=over 4

=item *	L<http://search.cpan.org/dist/PPI-App-ppi_version-BDFOY>

=item *	L<http://www.metacpan.org/module/PPI::App::ppi_version::BDFOY>
